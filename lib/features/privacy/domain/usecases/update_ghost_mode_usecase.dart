...
/// locked Ölkə/Dünya Discover radius options — see
/// `showPremiumUpsellSheet`), not re-checked here: by the time this
/// usecase runs, the UI has already decided the user is allowed to
/// set this value.
