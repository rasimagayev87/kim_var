...
class FirebasePinBoxRemoteDatasource implements PinBoxRemoteDatasource {
  FirebasePinBoxRemoteDatasource({
  ...
  CollectionReference<Map<String, dynamic>> get _pinboxes =>
      _firestore.collection('pinboxes');
  CollectionReference<Map<String, dynamic>> get _pinboxOrders =>
      _firestore.collection('pinboxOrders');
