...
const Map<NotificationType, IconData> _notificationIcons = {
  ...
  NotificationType.venuePremiumExpiringSoon: Icons.timer_outlined,
  NotificationType.venueWaitlistJoined: Icons.people_alt_outlined,
  NotificationType.dailyOffersDigest: Icons.bolt,
  NotificationType.dailyPinboxDigest: Icons.inventory_2_outlined,
  NotificationType.dailyEventsDigest: Icons.celebration_outlined,
  ...
  NotificationType.reviewPrompt: Icons.star_outline_rounded,
  ...
  NotificationType.pinboxNeedsRevision: Icons.edit_note_rounded,
