...
Future<void> checkAndShowConsentDialogIfNeeded(
  ...
  try {
    ...
    final currentPrivacy =
        configSnap.data()?['currentPrivacyVersion'] as String?;
    ...
    final consent = (userSnap.data()?['consent'] as Map?)
        ?.cast<String, dynamic>();
  ...
  Future<void> _accept() async {
    ...
    try {
      ...
      await FirebaseFunctions.instance
          .httpsCallable('recordConsent', options: callableOptions())
