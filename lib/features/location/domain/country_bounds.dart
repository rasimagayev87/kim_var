...
const kCountryBounds = <String, CountryBounds>{
  ...
  'Qazaxıstan': CountryBounds(
    swLat: 40.6,
    swLng: 46.5,
    neLat: 55.4,
    neLng: 87.3,
  ),
  'Özbəkistan': CountryBounds(
    swLat: 37.2,
    swLng: 55.9,
    neLat: 45.6,
    neLng: 73.1,
  ...
  'Səudiyyə Ərəbistanı': CountryBounds(
    swLat: 16.0,
    swLng: 34.5,
    neLat: 32.2,
    neLng: 55.7,
