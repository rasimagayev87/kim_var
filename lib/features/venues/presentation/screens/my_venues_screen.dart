            ...
            child: venuesAsync.when(
              ...
              data: (venues) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) => _MyVenueCard(venue: venues[index]),
                );
              },
            ),
          ),
...
class _MyVenueCard extends ConsumerWidget {
  ...
  Future<void> _openMenu(BuildContext context, WidgetRef ref) async {
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(loc.venueEditTitle, style: const TextStyle(fontSize: 15, color: ChatLightColors.ink)),
            ...
            ListTile(
              ...
              onTap: () => Navigator.pop(sheetContext, _MyVenueCardAction.delete),
            ),
            const SizedBox(height: 8),
          ],
        ),
    ...
    if (action == _MyVenueCardAction.edit) {
      Navigator.push(context, MaterialPageRoute(builder: (_) => CreateVenueScreen(existingVenue: venue)));
    } else {
  ...
  Future<void> _confirmDelete(BuildContext context, WidgetRef ref) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        backgroundColor: Colors.white,
        title: Text(loc.venueDeleteMenuOption, style: const TextStyle(color: ChatLightColors.ink, fontWeight: FontWeight.w700)),
        content: Text(
    ...
    final success = await ref.read(venueControllerProvider).deleteVenue(
          venue.id,
          onError: () {
    ...
    if (success && context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(loc.venueDeletedNotice)));
    }
  }
                  ...
                  child: SizedBox(
                    ...
                    child: venue.photoUrl != null
                        ...
                        : Container(
                            ...
                            child: Icon(venueCategoryIcon(venue.category), color: ChatLightColors.inkSoft, size: 26),
                          ),
                  ),
                ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (venue.address.isNotEmpty) ...[
                        ...
                        Text(
                          venue.address,
                          style: const TextStyle(fontSize: 12, color: ChatLightColors.inkFaint),
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                      ],
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: const Icon(Icons.storefront_outlined, color: ChatLightColors.inkFaint, size: 42),
            ),
